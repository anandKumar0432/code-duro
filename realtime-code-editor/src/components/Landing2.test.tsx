...
function Landing2() {
  ...
  return (
    <div className="flex justify-center items-center text-white h-screen w-screen font-mono " style={{backgroundColor: '#30353e'}}>
  <div className='flex flex-col h-72 w-72 border  border-gray-200 rounded-2xl' >
      ...
      <div>don't have a room id?</div>
        <button
          className="ml-2 text-white font-semibold hover:cursor-pointer underline"
          style={{backgroundColor: '#272640'}}
